...
## Task 2: Delete tasks with impaired vision
- **Scenario**: User (wearing 2 pairs of sunglasses) has multiple tasks- consisting of "Buy milk", "Buy eggs" and "Drink milk"- and they want to delete
...
## Task 3: Read tasks with screen reader
